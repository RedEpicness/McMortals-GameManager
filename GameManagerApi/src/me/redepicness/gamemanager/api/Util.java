...
public class Util {
    ...
    public static void setManagers(PlayerManager pmanager, GuiInventoryManager guimanager, BlockGenerator generator, ScoreboardManager smanager, CubeManager cmanager){
        if(set)
